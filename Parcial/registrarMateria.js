...
function registrarMateria() {
  ...
  materia.nota1.notas = JSON.parse(localStorage.getItem("notasPC"));
  materia.nota2.notas = JSON.parse(localStorage.getItem("notasSC"));
  materia.nota3.notas = JSON.parse(localStorage.getItem("notasTC"));
